...
import top.pfjia.connector.ResponseStream;
import top.pfjia.connector.ResponseWriter;
import top.pfjia.util.CookieTools;
...
*/
    ...
    public void sendStaticResource() throws IOException {
        ...
        try {
            ...
            File file = new File(Const.WEB_ROOT, request.getRequestURI());
